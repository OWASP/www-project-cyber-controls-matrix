...
Partial exception is made for articles, white papers, documentation, and sales collateral; whose attribution must at minimum include the following copyright and trademarks statement, to ensure the rights of the OCCM and its content are addressed: "The OWASP Cyber Controls Matrix (OCCM) [(https://cybercontrolsmatrix.com)](https://cybercontrolsmatrix.com) is copyright the OWASP Foundation, Inc. [(https://owasp.org)](https://owasp.org) and its creator Eric Bragger [(https://www.linkedin.com/in/eric-bragger/)](https://www.linkedin.com/in/eric-bragger/). All rights reserved. Control Identifiers (IDs), Control Names, Control Headings, Control Set Names, and Framework Names are copyright their respective owners. "OWASP"™, includings its logo and trade dress, is trademark the OWASP Foundation, Inc. "Cyber Controls Matrix"™ and "OCCM"™, including their logos and trade dress, are trademark Eric Bragger. All other trademarks belong to their respective owners. Prior to use of the OCCM or content related to the OCCM, visit the website at [(https://cybercontrolsmatrix.com)](https://cybercontrolsmatrix.com) for additional required information on licensing, copyrights, trademarks, disclaimers, and limitations."
